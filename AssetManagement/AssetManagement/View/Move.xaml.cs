...
namespace AssetManagement.View
{
    ...
    public partial class Move : ContentPage
    {
        ...
        public Move(STockTallyDetails details)
        {
            InitializeComponent();
            ViewModel = new MoveViewModel(details);
        ...
        private void pkrLocation_ItemSelected(object sender, ItemSelectedEventArgs e)
        {
            ViewModel.TOLOCATION = ViewModel.LocationList[e.SelectedIndex];
           
        }

        private void pkrBranch_ItemSelected(object sender, ItemSelectedEventArgs e)
        {
            ViewModel.TOBRANCH = ViewModel.BranchList[e.SelectedIndex];
