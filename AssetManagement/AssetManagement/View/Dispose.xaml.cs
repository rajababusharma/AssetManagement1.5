...
namespace AssetManagement.View
{
    ...
    public partial class Dispose : ContentPage
    {
        DisposeViewModel ViewModel;
        STockTallyDetails _details;
        MasterDetailPage1MasterViewModel masterDetail;
        public Dispose(STockTallyDetails details)
        {
            InitializeComponent();
            ViewModel = new DisposeViewModel(details);
        ...
        private void pkrmode_ItemSelected(object sender, ItemSelectedEventArgs e)
        {
            ViewModel.DISPOSALMODE = ViewModel.DISPOSALMODES[e.SelectedIndex];
        }

        private void pkrreason_ItemSelected(object sender, ItemSelectedEventArgs e)
        {
            ViewModel.REASON = ViewModel.DISPOSALREASONS[e.SelectedIndex];
        }
    }
}